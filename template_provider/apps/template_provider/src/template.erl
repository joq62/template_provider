...
-define(SERVER,TO_BE_CHANGED_Provider_server).
...
%% @end
%%--------------------------------------------------------------------
Function(Args,{SenderNode,SenderPid,Module,FunctionName,Line,TimeStamp})->
...
Function(Args)->
    gen_server:call(?SERVER, {Function,Args},infinity).
